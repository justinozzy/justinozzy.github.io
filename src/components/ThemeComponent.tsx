...
const ThemeComponent = () => {
  // Check for a stored theme in localStorage or default to system preference
  const getInitialTheme = () => {
    ...
    return "light"; // Default to "light" if running on the server
  };
  ...
  useEffect(() => {
    // Update the theme icon and HTML attribute based on theme
